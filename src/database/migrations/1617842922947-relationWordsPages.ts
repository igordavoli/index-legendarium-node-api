...
export class relationWordsPages1617842922947 implements MigrationInterface {
    name = 'relationWordsPages1617842922947'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_pages" ("page" integer PRIMARY KEY NOT NULL, "created_at" datetime NOT NULL, "created_by" varchar NOT NULL, CONSTRAINT "UQ_d60215c3b81238826895da4bf11" UNIQUE ("page"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pages" ("page" integer PRIMARY KEY NOT NULL, "created_at" timestamp NOT NULL DEFAULT (now()), "created_by" varchar NOT NULL, CONSTRAINT "UQ_d60215c3b81238826895da4bf11" UNIQUE ("page"))`);
