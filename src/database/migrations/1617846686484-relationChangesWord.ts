...
export class relationChangesWord1617846686484 implements MigrationInterface {
    name = 'relationChangesWord1617846686484'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_changes_history" ("id" uuid PRIMARY KEY NOT NULL, "word_id" uuid NOT NULL, "created_by" uuid NOT NULL, "vocable" varchar NOT NULL, "language" varchar, "type" varchar, "meaning" text, "about" text)`);
        await queryRunner.query(`INSERT INTO "temporary_changes_history"("id", "word_id", "created_by", "vocable", "language", "type", "meaning", "about") SELECT "id", "word_id", "created_by", "vocable", "language", "type", "meaning", "about" FROM "changes_history"`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_changes_history" ("id" uuid PRIMARY KEY NOT NULL, "word_id" uuid NOT NULL, "created_by" uuid NOT NULL, "vocable" varchar NOT NULL, "language" varchar, "type" varchar, "meaning" text, "about" text, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "seeToo" varchar NOT NULL)`);
        await queryRunner.query(`INSERT INTO "temporary_changes_history"("id", "word_id", "created_by", "vocable", "language", "type", "meaning", "about") SELECT "id", "word_id", "created_by", "vocable", "language", "type", "meaning", "about" FROM "changes_history"`);
        await queryRunner.query(`DROP TABLE "changes_history"`);
        await queryRunner.query(`ALTER TABLE "temporary_changes_history" RENAME TO "changes_history"`);
        await queryRunner.query(`CREATE TABLE "temporary_users" ("id" varchar PRIMARY KEY NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "email" varchar NOT NULL, "user_name" varchar NOT NULL, "password" varchar NOT NULL, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_074a1f262efaca6aba16f7ed920" UNIQUE ("user_name"))`);
        ...
        await queryRunner.query(`DROP TABLE "pages"`);
        await queryRunner.query(`ALTER TABLE "temporary_pages" RENAME TO "pages"`);
        await queryRunner.query(`CREATE TABLE "temporary_changes_history" ("id" varchar PRIMARY KEY NOT NULL, "word_id" varchar NOT NULL, "created_by" varchar NOT NULL, "vocable" varchar NOT NULL, "language" varchar NOT NULL, "type" varchar NOT NULL, "meaning" varchar NOT NULL, "about" varchar NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "seeToo" varchar NOT NULL)`);
        ...
        await queryRunner.query(`DROP TABLE "changes_history"`);
        await queryRunner.query(`ALTER TABLE "temporary_changes_history" RENAME TO "changes_history"`);
        await queryRunner.query(`CREATE TABLE "temporary_changes_history" ("id" varchar PRIMARY KEY NOT NULL, "word_id" varchar NOT NULL, "created_by" varchar NOT NULL, "vocable" varchar NOT NULL, "language" varchar NOT NULL, "type" varchar NOT NULL, "meaning" varchar NOT NULL, "about" varchar NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "seeToo" varchar NOT NULL, CONSTRAINT "FK_eb2105759f0408e3bd530458a86" FOREIGN KEY ("word_id") REFERENCES "words" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_changes_history"("id", "word_id", "created_by", "vocable", "language", "type", "meaning", "about", "createdAt", "seeToo") SELECT "id", "word_id", "created_by", "vocable", "language", "type", "meaning", "about", "createdAt", "seeToo" FROM "changes_history"`);
        await queryRunner.query(`DROP TABLE "changes_history"`);
        await queryRunner.query(`ALTER TABLE "temporary_changes_history" RENAME TO "changes_history"`);
        await queryRunner.query(`DROP INDEX "IDX_410b97389f40639f46df44a95c"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "changes_history" ("id" varchar PRIMARY KEY NOT NULL, "word_id" varchar NOT NULL, "created_by" varchar NOT NULL, "vocable" varchar NOT NULL, "language" varchar NOT NULL, "type" varchar NOT NULL, "meaning" varchar NOT NULL, "about" varchar NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "seeToo" varchar NOT NULL)`);
        ...
        await queryRunner.query(`ALTER TABLE "changes_history" RENAME TO "temporary_changes_history"`);
        await queryRunner.query(`CREATE TABLE "changes_history" ("id" uuid PRIMARY KEY NOT NULL, "word_id" uuid NOT NULL, "created_by" uuid NOT NULL, "vocable" varchar NOT NULL, "language" varchar, "type" varchar, "meaning" text, "about" text, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "seeToo" varchar NOT NULL)`);
        await queryRunner.query(`INSERT INTO "changes_history"("id", "word_id", "created_by", "vocable", "language", "type", "meaning", "about", "createdAt", "seeToo") SELECT "id", "word_id", "created_by", "vocable", "language", "type", "meaning", "about", "createdAt", "seeToo" FROM "temporary_changes_history"`);
        await queryRunner.query(`DROP TABLE "temporary_changes_history"`);
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" varchar PRIMARY KEY NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "email" varchar NOT NULL, "user_name" varchar NOT NULL, "password" varchar NOT NULL, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_074a1f262efaca6aba16f7ed920" UNIQUE ("user_name"))`);
        ...
        await queryRunner.query(`ALTER TABLE "changes_history" RENAME TO "temporary_changes_history"`);
        await queryRunner.query(`CREATE TABLE "changes_history" ("id" uuid PRIMARY KEY NOT NULL, "word_id" uuid NOT NULL, "created_by" uuid NOT NULL, "vocable" varchar NOT NULL, "language" varchar, "type" varchar, "meaning" text, "about" text)`);
        await queryRunner.query(`INSERT INTO "changes_history"("id", "word_id", "created_by", "vocable", "language", "type", "meaning", "about") SELECT "id", "word_id", "created_by", "vocable", "language", "type", "meaning", "about" FROM "temporary_changes_history"`);
        await queryRunner.query(`DROP TABLE "temporary_changes_history"`);
        await queryRunner.query(`ALTER TABLE "changes_history" RENAME TO "temporary_changes_history"`);
        await queryRunner.query(`CREATE TABLE "changes_history" ("id" uuid PRIMARY KEY NOT NULL, "word_id" uuid NOT NULL, "created_by" uuid NOT NULL, "created_at" timestamp NOT NULL DEFAULT (now()), "vocable" varchar NOT NULL, "language" varchar, "type" varchar, "meaning" text, "about" text, "see_too" text)`);
        await queryRunner.query(`INSERT INTO "changes_history"("id", "word_id", "created_by", "vocable", "language", "type", "meaning", "about") SELECT "id", "word_id", "created_by", "vocable", "language", "type", "meaning", "about" FROM "temporary_changes_history"`);
        await queryRunner.query(`DROP TABLE "temporary_changes_history"`);
        await queryRunner.query(`ALTER TABLE "pages" RENAME TO "temporary_pages"`);
        await queryRunner.query(`CREATE TABLE "pages" ("page" integer PRIMARY KEY NOT NULL, "created_at" datetime NOT NULL, "created_by" varchar, CONSTRAINT "UQ_d60215c3b81238826895da4bf11" UNIQUE ("page"), CONSTRAINT "FK_064ab67bb29a28d073db287fc6d" FOREIGN KEY ("created_by") REFERENCES "users" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
